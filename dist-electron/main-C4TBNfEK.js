...
ipcMain.handle("assistant:run", async (_event, {
  ...
  const { GoogleGenAI } = await import("./index-CDJHaFTh.js");
  const ai = new GoogleGenAI({ apiKey });
  const res = await ai.models.generateContent({
    model: (options == null ? void 0 : options.model) || "gemini-2.0-flash",
    generationConfig: (options == null ? void 0 : options.temperature) !== void 0 ? { temperature: options.temperature } : void 0,
    contents: `${system}
